...
<c:if test="${adListing!=null}">
	<table>
		<tr bgcolor="#cccccc" align="center">
			<td>Тема объявления<br> 
				<a href="<c:url value="${jspContext.request.requestURL}">
					<c:param name="sort" value="subject"/>
					<c:param name="dir" value="asc"/></c:url>">
					<img src="
						<c:url value="/resources/asc.png"/>" width="20" height="19" border="0" align="middle"></a>
				<a href="<c:url value="${jspContext.request.requestURL}">
					<c:param name="sort" value="subject"/>
					<c:param name="dir" value="desc"/>
					</c:url>">
					<img src="<c:url value="/resources/desc.png"/>" width="20" height="19"border="0" align="middle"></a>
			</td>
			<td>Автор<br> <a
				href="<c:url
value="${jspContext.request.requestURL}">
...
<c:param name="dir" value="desc"/>
	...
	<img src="<c:url value="/resources/desc.png"
/>" width="20" height="19"
					border="0" align="middle"></a>
			</td>
